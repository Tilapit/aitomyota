...
export default function TherapistLandingPage() {
  ...
  usePageMeta(
    locale === "fi" ? "Myötä | Terapeuteille" : "Myötä | For therapists",
    locale === "fi"
      ? "Luo terapeuttiprofiili, joka kuulostaa sinulta ja auttaa oikeita asiakkaita löytämään sinut."
      : "Build a therapist profile that sounds like you and helps the right clients find their way to you.",
  );
  ...
  return (
    <>
      <Navbar locale={locale} audience="therapist" />
