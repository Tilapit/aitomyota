...
const ClientSavedResultsPage = lazy(() => import("./pages/ClientSavedResultsPage"));
  ...
  return (
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        <Route path="auth" element={<Navigate to={routePaths.clientAuth(locale)} replace />} />
        ...
        <Route
          path="results"
          element={
            <ProtectedRoute locale={locale} redirectTo={routePaths.clientAuth(locale)}>
              <ClientSavedResultsPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              ...
              missingRoleRedirectTo={routePaths.therapistQuiz(locale)}
            >
