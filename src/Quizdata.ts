...
export const longQuiz: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      category: "tilanne",
      question:
        "Mistä elämän alueesta haluaisit ensisijaisesti puhua? Voit valita useamman.",
      multiSelect: true,
      answers: [
    ...
    },
    {
      ...
      category: "historia",
      question:
        "Oletko aiemmin käynyt terapiassa tai saanut vastaavaa ammatillista tukea?",
      answers: [
    ...
    },
    {
      ...
      category: "historia",
      question:
        "Jos olet käynyt aiemmin, mikä siinä tuntui hyvältä tai mikä jäi puuttumaan?",
      answers: [
    ...
    },
    {
      ...
      category: "sinä",
      question:
        "Onko jotain muuta, mitä haluaisit ammattilaisen tietävän sinusta ennen ensitapaamista?",
      openText: true,
