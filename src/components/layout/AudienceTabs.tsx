...
export default function AudienceTabs({ locale, active }: AudienceTabsProps) {
  const { t } = useTranslation("common");

  const tabs = [
    { id: "client" as const, label: t("audienceTabs.forClients"), href: routePaths.clientHome(locale) },
    { id: "therapist" as const, label: t("audienceTabs.forTherapists"), href: routePaths.therapistLanding(locale) },
  ];
